...
type ServiceAClient interface {
	GetList(ctx context.Context, in *ID, opts ...grpc.CallOption) (*FileList, error)
}
...
func (c *serviceAClient) GetList(ctx context.Context, in *ID, opts ...grpc.CallOption) (*FileList, error) {
	out := new(FileList)
	err := c.cc.Invoke(ctx, "/sa.ServiceA/GetList", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ServiceAServer interface {
	GetList(context.Context, *ID) (*FileList, error)
...
func (UnimplementedServiceAServer) GetList(context.Context, *ID) (*FileList, error) {
...
func _ServiceA_GetList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ID)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ServiceAServer).GetList(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/sa.ServiceA/GetList",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ServiceAServer).GetList(ctx, req.(*ID))
	}
...
var ServiceA_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "sa.ServiceA",
	HandlerType: (*ServiceAServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "GetList",
			Handler:    _ServiceA_GetList_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "protos/s.proto",
}
